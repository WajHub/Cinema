...
public class GlobalExceptionHandler {
  ...
  @ExceptionHandler(DoubleBokingException.class)
  public ProblemDetail handleDoubleBookingException(
      DoubleBokingException ex, HttpServletRequest request) {
    log.warn("DoubleBokingException on {}: {}", request.getRequestURI(), ex.getMessage());
    ProblemDetail problem = ProblemDetail.forStatusAndDetail(
        HttpStatus.CONFLICT,
        ex.getMessage() != null ? ex.getMessage() : "One or more seats were already reserved by another user. Please try again."
    );
